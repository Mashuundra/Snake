...
class TestSnakeMovement:
    ...
    def test_move_right(self):
        ...
        snake.move_with_teleport(new_head)
...
class TestSnakeTeleport:
    """Тесты телепортации головы (через move_with_teleport)"""

    def test_move_with_teleport_new_position(self):
        snake = Snake(5, 5)
        snake.move_with_teleport((10, 20))
        assert snake.head == (10, 20)

    def test_move_with_teleport_growth(self):
        snake = Snake(5, 5)
        old_length = snake.length
        snake.grow()
        snake.move_with_teleport((10, 20))
